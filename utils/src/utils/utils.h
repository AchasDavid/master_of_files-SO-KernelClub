...
t_log *create_logger(char *directory, char *process_name,
                     bool is_active_console, t_log_level log_level);
 ...
 * @return bool true si la ruta es un archivo regular existente, false en caso
 * contrario.
 */
